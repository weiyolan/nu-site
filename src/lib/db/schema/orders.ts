...
export const orders = pgTable("orders", {
  ...
  shippingName: varchar("shipping_name", { length: 256 }).notNull(),
  billingAddressLine1: varchar("billing_address_line_1", { length: 256 }).notNull(),
  billingAddressCity: varchar("billing_address_city", { length: 256 }).notNull(),
  billingAddressCountry: varchar("billing_address_country", { length: 256 }).notNull(),
  billingAddressPostalCode: varchar("billing_address_postal_code", { length: 256 }).notNull(),
