  ...
  return (
    <Sheet key={"right"}>
      ...
      <SheetContent side={"right"} className="sm:max-w-md">
        ...
        <Card>
          <CardContent className="flex p-2 flex-row items-start gap-4 bg-muted/50">
            <div className="flex flex-row items-start gap-4 bg-muted/50">
              <div className="w-24 relative">
                <AspectRatio ratio={1}>
                  <Image alt="dog" className="object-cover" src="/main_dog.jpg" fill />
                </AspectRatio>
              </div>
              <div>
                <CardTitle className="text-lg">Chaos</CardTitle>
                <CardDescription>Shampoing solide pour cheveux sec</CardDescription>
              </div>
            </div>
          </CardContent>
        </Card>
