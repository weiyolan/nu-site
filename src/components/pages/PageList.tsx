...
import { useOptimisticPages } from "@/app/[locale]/account/pages/useOptimisticPages";
...
export default function PageList({ pages }: { pages: CompletePage[] }) {
  ...
  return (
    <div>
      <Modal open={open} setOpen={setOpen} title={activePage ? "Edit Page" : "Create Page"}>
        <PageForm page={activePage} addOptimistic={addOptimisticPage} openModal={openModal} closeModal={closeModal} />
      </Modal>
...
const Page = ({ page, openModal }: { page: CompletePage; openModal: TOpenModal }) => {
...
const EmptyState = ({ openModal }: { openModal: TOpenModal }) => {
  return (
    <div className="text-center">
      <h3 className="mt-2 text-sm font-semibold text-secondary-foreground">No pages</h3>
      <p className="mt-1 text-sm text-muted-foreground">Get started by creating a new page.</p>
      <div className="mt-6">
