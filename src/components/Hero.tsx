...
export default function Hero({ locale, hero: { title, button, altImage }, increasedContrast, children, className, ...props }: HeroProps) {
  return (
    <div className={cn("w-full h-screen relative overflow-hidden ", className)} {...props}>
      ...
      <div className="absolute top-2/3 md:top-1/2 ml-6 sm:ml-12 md:ml-24 -translate-y-1/2">
        <div className="w-[200vw] h-48 bg-nu-blue absolute rotate-12 -translate-x-48 translate-y-12"></div>
