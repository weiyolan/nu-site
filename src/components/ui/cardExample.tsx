...
export interface CardExampleProps extends React.HTMLAttributes<HTMLDivElement> {}

export default function CardExample({ children, className, ...props }: CardExampleProps) {
  return (
    <Card className="">
