...
export async function POST(request: Request) {
  ...
  //YW: if checkout session completed, retrieve data from checkout session and try to update subscription table.
  ...
  //YW: subscription has recurring invoices so this is probably why we have another event here
