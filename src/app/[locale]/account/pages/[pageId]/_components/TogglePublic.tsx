...
export default function TogglePublic({ isSubscribed, page }: { isSubscribed: boolean; page: Page }) {
    ...
    <div className="relative">
      {isSubscribed ? null : (
        <div className="absolute w-full bg-white h-full top-0 right-0 z-50 opacity-90 flex items-center justify-center flex-col">
          <p className="font-bold text-lg select-none mb-2">You need to subscribe to share this page</p>
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>Anyone with the link can view this page.</CardDescription>
        </CardHeader>
        <CardContent>
          {page.public ? (
            ...
            <div>
              <Button onClick={async () => await updatePageAction({ ...page, public: true })}>Make public</Button>
            </div>
          )}
        </CardContent>
      </Card>
